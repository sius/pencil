...
public interface WithEncodingId {
     ...
     */
    PencilPasswordEncoder withEncodingId();
     ...
     * @return this <code>PasswordEncoder</code>
     */
    PencilPasswordEncoder withEncodingId(String encodingId);

    /**
     * Removes any brackets: {,},(,),[,] from the specified encodingId
     * @param encodingId
     * @return
     */
    default String sanitizeEncodingId(String encodingId) {
        return (encodingId != null)
            ? encodingId.replaceAll("[{}\\(\\)\\[\\]]", "")
            : null;
    }
}
