...
/**
 * Salted or unsalted SHA-224 PasswordEncoder supporting
...
public final class SSHA224PasswordEncoder extends SaltedMessageDigestPasswordEncoder {
  ...
  /**
   * Creates a PasswordEncoder using SHA-224 algorithm,
  ...
  /**
   * Creates a PasswordEncoder using salted or unsalted SHA-224 algorithm and
   * a single digest iteration
   *
   * @param saltGenerator  a custom salt byte array generator
   */
  public SSHA224PasswordEncoder(BytesKeyGenerator saltGenerator) {
    this(saltGenerator, 1, false, false);
  }

  /**
   * Creates a PasswordEncoder using salted or unsalted SHA-224 algorithm,
   ...
   */
  public SSHA224PasswordEncoder(BytesKeyGenerator saltGenerator, int iterations, boolean ufSafe, boolean noPadding) {
    super(SHA224_ALGORITHM, SHA224_HASH_SIZE, saltGenerator, iterations, ufSafe, noPadding);
  }
