...
public class PasswordEncoderTest {
  ...
  void encoded_password_should_start_with_encode_identifier(String encodeId, String identifier) {
    ...
    final PasswordEncoder passwordEncoder = PencilPasswordEncoderFactory.passwordEncoder(encodeId);
  ...
  void encoded_passwords_should_match(String encodeId, String encodedPassword) {
    ...
    final PasswordEncoder passwordEncoder = PencilPasswordEncoderFactory.passwordEncoder();
    Assertions.assertTrue(passwordEncoder.matches(expectedPassword, encodedPassword));
  }
